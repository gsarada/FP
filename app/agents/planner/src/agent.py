...
TAGGER_FUNCTION = os.getenv("TAGGER_FUNCTION", f"fp-{ENV}-tagger")
REPORTER_FUNCTION = os.getenv("REPORTER_FUNCTION", f"fp-{ENV}-reporter")
CHARTER_FUNCTION = os.getenv("CHARTER_FUNCTION", f"fp-{ENV}-charter")
RETIREMENT_FUNCTION = os.getenv("RETIREMENT_FUNCTION", f"fp-{ENV}-retirement")
...
def create_agent(job_id: str, portfolio_summary: Dict[str, Any]):
