...
export default function Home() {
  return (
    <>
      <Head>
        <title>AI Financial Advisor - Intelligent Portfolio Management</title>
      </Head>
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-50">
      ...
      <nav className="px-8 py-6 bg-white shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="text-2xl font-bold text-dark">
            Smart <span className="text-primary">AI Financial Advisor</span>
          </div>
      ...
      <footer className="px-8 py-6 bg-gray-900 text-gray-400 text-center text-sm">
        <p>© AI Financial Advisor. All rights reserved.</p>
        <p className="mt-2">
